...
TK_CLS		= TK_NMI+1		; NMI token
TK_WRITE    = TK_CLS+1		; NMI token
TK_SETX     = TK_WRITE+1		; SETX TOKEN
TK_SETY     = TK_SETX+1		; SETX TOKEN
TK_DELAY    = TK_SETY+1		; DELAY token
...
Ram_top		= $7fff	; end of user RAM+1 (set as needed, should be page aligned)
...
LAB_SMSG
	.byte	"      *** Enhanced BASIC 2.22 ***",$0D,$0A
   .byte	"Bytes free:",$00
...
LAB_CTBL
	...
	.word	LAB_WRITE-1		; WRITE			new command
	.word	LAB_SETX-1		; SETX
	.word	LAB_SETY-1		; SETX
...
LBB_SETX
	.byte	"ETX",TK_SETX	; SETX x,y
LBB_SETY
	.byte	"ETY",TK_SETY	; SETX x,y
LBB_SGN
	.byte	"GN(",TK_SGN	; SGN(
LBB_SIN
	.byte	"IN(",TK_SIN	; SIN(
